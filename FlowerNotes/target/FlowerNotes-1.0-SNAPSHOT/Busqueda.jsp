...
<%
    ...
    List<Nota> notes = (List<Nota>) request.getAttribute("notasPaginadas");
    List<Nota> notesTOTAL = (List<Nota>) request.getAttribute("TotalNotes");
...
//Muestra las etiquetas
    ...
    int paginacion = 1;
    int notas = 10;
    for (Nota no : notesTOTAL) { //Sumara la cantidad de notas que hay
        CantidadNotas++;
                ...
                <div class="col">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center">  
                            ...
                            <form action = "PaginacionBuscar?page=<%= limite%>" method = "POST" >
                                <input type="text" value="<%= busqueda%>" name="buscar" style="display: none">
                                <li >
                                    <button class="page-link" onclick="location.href = 'PaginacionBusqueda?page=<%= limite%>';" type="submit"> <%= limite%> </button>  
